...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public BigDecimal getTotalRefundsBetweenDates(TransactionType transactionType, LocalDate startDate, LocalDate endDate) {
        LocalDateTime startDateTime = startDate.atStartOfDay();
        LocalDateTime endDateTime = endDate.atTime(23, 59, 59);

        BigDecimal totalRefunds = transactionRepository.getTotalsBetweenDates(TransactionType.REFUND, startDateTime, endDateTime);

        return totalRefunds;
    }

    @Override
    public BigDecimal getTotalIncomeBetweenDates(TransactionType transactionType, LocalDate startDate, LocalDate endDate) {
        LocalDateTime startDateTime = startDate.atStartOfDay();
        LocalDateTime endDateTime = endDate.atTime(23, 59, 59);

        BigDecimal totalIncome = transactionRepository.getTotalsBetweenDates(TransactionType.INCOME, startDateTime, endDateTime);
